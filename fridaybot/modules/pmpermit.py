...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/a59e07a9e435ea9e7ca03.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By ₘᵢGₕₜY_ₖₑᵥᵢₙ_bₒₜ 🐰"
)
...
USER_BOT_NO_WARN = (
    "**Hello, This is ꪑⅈᧁꫝ𝕥ꪗ_𝕜ꫀꪜⅈꪀ Protection Service ⚠️**\n\n"
